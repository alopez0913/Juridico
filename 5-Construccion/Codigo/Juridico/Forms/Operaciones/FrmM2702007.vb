...
Public Class FrmM2702007
    ...
    Public Sub llenacomboMoneda()
        ...
        Next
    End Sub
    Private Sub FrmM2702007_Load(sender As Object, e As EventArgs) Handles Me.Load
        Dim DtPersona As New DataTable
        Dim ADDA As AsistenteDeDatos_Base = AsistenteDeDatos_Base.DevuelveInstancia
        DtPersona = FabricaJuridicoJosue.FgConsultaNombreLogin(ADDA.GetLoginUsuario)
        txtDepartamento.Enabled = False
        ...
        cmbsolicitar.Items.Add(("Aceptar"))
        cmbsolicitar.Items.Add(("Rechazar"))
    End Sub
    ...
    Private Sub EnviarCorreo(nFolio As Integer)
        ...
        If dt.Rows.Count > 0 Then
            For i = 0 To dt.Rows.Count - 1
                If dt(i)("ntipo") = 1 Then
                    contraobligados = contraobligados + " Contratante: "
                Else
        ...
        cAsunto = "Alta De Solicitud De " & soli & "De  Contrato Num: " & nFolio & " de la Empresa: " & ADDA.NombreCortoEmpresa
